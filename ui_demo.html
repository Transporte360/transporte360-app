...
<body>
  ...
  <section id="viewLogin" class="login-wrap">
    <div class="login-card">
      <div class="login-head">
        <div class="login-brand">
          ...
          <div class="col" style="gap:2px">
            ...
            <div class="tiny">Sistema de Gestión de Flotas</div>
          </div>
        </div>
      ...
      <form id="loginForm" class="col" style="gap:12px; position:relative">
        ...
        <div class="field">
          <div class="label">🔒 PIN (4 dígitos)</div>
          <div style="position:relative">
            <svg class="icon-left" viewBox="0 0 24 24" fill="none">
            ...
            <input class="input" id="pin" name="pin" placeholder="••••" inputmode="numeric" pattern="[0-9]{4}" maxlength="4" required />
            <button type="button" class="icon-btn" id="togglePin" aria-label="Mostrar/Ocultar PIN">👁️</button>
          </div>
    ...
    <div class="app-shell">
      ...
      <aside class="sidebar">
        ...
        <div class="tiny" style="color:rgba(255,255,255,.72); padding:0 6px">
          Usuario: <span id="userName" style="color:#fff; font-weight:900">—</span><br/>
          Rol: <span id="userRole" style="color:#fff; font-weight:900">—</span>
        </div>
        ...
        <div class="nav" id="nav">
          ...
          <a href="#" data-screen="trips">
            <span class="nav-ic">🧾</span> Viajes
          </a>
          <a href="#" data-screen="fuel">
            <span class="nav-ic">⛽</span> Repostajes
          </a>
          <a href="#" data-screen="drivers">
            <span class="nav-ic">👷</span> Conductores
          </a>
          <a href="#" data-screen="vehicles">
            <span class="nav-ic">🚚</span> Vehículos
          </a>
          <a href="#" data-screen="docs">
            <span class="nav-ic">📎</span> Documentos
          </a>
      ...
      <main class="content">
        <div class="topbar">
          <div class="col" style="gap:2px">
            <div class="h1" id="screenTitle">Panel de Gestión</div>
            <div class="muted" id="screenSubtitle">Resumen mensual de operaciones — Enero 2026</div>
          </div>
          ...
          <div class="right">
            ...
            <button class="btn btn-primary" type="button" id="addActionBtn">+ Nueva acción</button>
          </div>
        </div>
        ...
        <section id="screen-dashboard" class="col" style="gap:14px">
          ...
          <div class="grid g4">
            <div class="stat">
              <div class="row" style="justify-content:space-between">
                <div class="h2">Kilómetros Totales</div>
            ...
            <div class="stat">
              <div class="row" style="justify-content:space-between">
                <div class="h2">Kilómetros Vacíos</div>
          ...
          <div class="grid g3">
            <div class="card card-pad">
              <div class="row" style="justify-content:space-between">
                ...
                <span class="chip">€18.560</span>
              </div>
              <div class="tiny" style="margin-top:6px">Combustible <b>€12.340</b> · Peajes <b>€4.520</b> · Otros <b>€1.700</b></div>
              <div class="chart-area" style="margin-top:12px; height:140px">placeholder gráfico variables</div>
            </div>

            <div class="card card-pad">
              <div class="row" style="justify-content:space-between">
                <div class="h2">Combustible Real</div>
                <span class="chip">€12.340</span>
              </div>
              <div class="tiny" style="margin-top:6px">Litros totales <b>8,227 L</b> · Precio medio <b>€1.50/L</b> · Consumo <b>18.2 L/100km</b></div>
              <div class="chart-area" style="margin-top:12px; height:140px">placeholder gráfico combustible</div>
            </div>

            <div class="card card-pad">
              <div class="row" style="justify-content:space-between">
                <div class="h2">Costes Fijos Asignados</div>
                <span class="chip">€10.589</span>
              </div>
              <div class="tiny" style="margin-top:6px">Seguros <b>€4.200</b> · Mantenimiento <b>€3.890</b> · Otros <b>€2.499</b></div>
              <div class="chart-area" style="margin-top:12px; height:140px">placeholder gráfico fijos</div>
            </div>
          </div>
          ...
          <div class="grid g2">
            ...
            <div class="chart">
              <div class="row" style="justify-content:space-between">
                <div class="h2">Distribución de Viajes</div>
              ...
              <div class="row" style="justify-content:space-between">
                ...
                <span class="tiny"><b>18.2%</b> Vacíos (26)</span>
              </div>
            </div>
          </div>
          ...
          <div class="card card-pad">
            ...
            <div class="grid g2">
              <div class="card card-pad" style="box-shadow:none; background:#fbfdff">
                <div class="row" style="justify-content:space-between">
                  <div style="font-weight:900">Miguel Fernández</div>
                  <span class="chip up">Cargado</span>
                </div>
                <div class="tiny">ABC-1234 · 15/01/2026</div>
                <div class="row" style="justify-content:space-between; margin-top:8px">
                  <div style="font-weight:800; color:var(--primary)">Madrid → Barcelona</div>
                  <div class="tiny">628 km</div>
                </div>
                <div class="row" style="justify-content:space-between; margin-top:6px">
                  <div class="tiny">Ingresos</div>
                  <div style="font-weight:900">€753.60</div>
                </div>
              </div>

              <div class="card card-pad" style="box-shadow:none; background:#fbfdff">
                <div class="row" style="justify-content:space-between">
                  <div style="font-weight:900">Ana Martínez</div>
                  <span class="chip down">Vacío</span>
                </div>
                <div class="tiny">XYZ-5678 · 15/01/2026</div>
                <div class="row" style="justify-content:space-between; margin-top:8px">
                  <div style="font-weight:800; color:var(--primary)">Valencia → Sevilla</div>
        ...
        <section id="screen-trips" class="hidden">
          <div class="card card-pad">
            ...
            <div class="muted">Aquí va tu tabla/lógica actual — solo formato ya está.</div>
          </div>
        </section>
        ...
        <section id="screen-fuel" class="hidden">
          <div class="card card-pad">
            ...
            <div class="muted">Aquí metes tu sección de repostajes con este mismo estilo.</div>
          </div>
        </section>
        ...
        <section id="screen-drivers" class="hidden">
          <div class="card card-pad">
            ...
            <div class="muted">Listado + alta/edición con cards y botones.</div>
          </div>
        </section>
        ...
        <section id="screen-vehicles" class="hidden">
          <div class="card card-pad">
            ...
            <div class="muted">Ficha del camión, ITV, seguro, etc.</div>
          </div>
        </section>
        ...
        <section id="screen-docs" class="hidden">
          <div class="card card-pad">
            ...
            <div class="muted">CMR, facturas, recibos…</div>
          </div>
        </section>
        ...
        <section id="screen-settings" class="hidden">
          <div class="card card-pad">
            ...
            <div class="muted">Roles, usuarios, parámetros, etc.</div>
          </div>
        </section>
  ...
  <script>
    ...
    function switchScreen(screen){
      ...
      if(screen === "dashboard"){
        screenTitle.textContent = "Panel de Gestión";
        screenSubtitle.textContent = "Resumen mensual de operaciones — Enero 2026";
      } else {
        const titles = {
          trips:"Viajes",
          fuel:"Repostajes",
        ...
        screenTitle.textContent = titles[screen] || "Sección";
        screenSubtitle.textContent = "Transporte360 — Operaciones";
      }
    }
    ...
    addActionBtn.addEventListener("click", () => {
      alert("Aquí conectas tu lógica: nuevo viaje / nuevo repostaje / etc. (solo UI ahora).");
    });
